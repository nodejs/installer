# Contributing to the Node.js Installer
...
discussions are related to concrete technical issues with the Node.js Installer -
specifically, the Electron-based installer found in this repository.
...
Fork the project [on GitHub](https://github.com/nodejs/installer) and clone your fork
locally.

```text
$ git clone git@github.com:username/installer.git
$ cd node
$ git remote add upstream https://github.com/nodejs/installer.git
```
...
tests in the `spec/` directory if you are unsure where to put them.
...
at least one Node.js Installer Collaborator.
